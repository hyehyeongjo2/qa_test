export class routesumulation_hyundai_1 {
    constructor() {
        this.mapData = null;
        this.map = null;
    ...
    async init(menu, mapData, map, mapContainer) {
        ...
        this.menu = menu.addFolder('현대_압구정');
    ...
    async stair_1_2_3() {
        const route = {
            origin: {
                poiId: 'PO-16biej8v8G9351',
                floorId: 'FL-t8a5mogl11dj1224',
            },
            destination: {
                poiId: 'PO-oqyZ7Rxgv5789',
                floorId: 'FL-s507go7mptme1201',
            },
            type: ['recommendation'],
            waypoints: [
                {
                    poiId: 'PO-o10tMKNZr3062',
                    floorId: 'FL-1h7o7aro086le1238',
                },
            ],
        };
    ...
    async st_es_1_2_3() {
        const route = {
            ...
            destination: {
                poiId: 'PO-Kg8wEHQnK5342',
                floorId: 'FL-s507go7mptme1201',
            },
            type: ['recommendation'],
            waypoints: [
                {
                    poiId: 'PO-GpeMZrwSt3738',
                    floorId: 'FL-1h7o7aro086le1238',
                },
            ],
        };
    ...
    async st_ev_1_2_3() {
        const route = {
            ...
            destination: {
                poiId: 'PO-k235m8VUj0557',
                floorId: 'FL-s507go7mptme1201',
            },
            type: ['recommendation'],
            waypoints: [
                {
                    poiId: 'PO-He2Mb4kz73819',
                    floorId: 'FL-1h7o7aro086le1238',
                },
            ],
        };
    ...
    async es_ev_1_2_1() {
        const route = {
            ...
            destination: {
                poiId: 'PO-Qhm4BksOVo2096',
                floorId: 'FL-t8a5mogl11dj1224',
            },
            type: ['recommendation'],
            waypoints: [
                {
                    poiId: 'PO-xXdoAfCUK9890',
                    floorId: 'FL-1h7o7aro086le1238',
                },
            ],
        };
